...
#define RG_GAMEPAD_ADC1_MAP {\
    {RG_KEY_UP,    ADC1_CHANNEL_6, ADC_ATTEN_DB_11, 3000, 4096},\
    {RG_KEY_DOWN,  ADC1_CHANNEL_6, ADC_ATTEN_DB_11, 1300, 1900},\
    {RG_KEY_LEFT,  ADC1_CHANNEL_5, ADC_ATTEN_DB_11, 3000, 4096},\
    {RG_KEY_RIGHT, ADC1_CHANNEL_5, ADC_ATTEN_DB_11, 1600, 1900},\
}
// GPIO6 GPIO7
...
#define RG_BATTERY_CALC_PERCENT(raw) (((raw) * 2.f - 2000.f) / (2800.f - 2000.f) * 100.f)
