...
#define RG_SCREEN_MARGIN_LEFT       9
...
#define RG_SCREEN_INIT()                                                                                         \
    ...
    ILI9341_CMD(0x36, ((0x60|0x08)^0xC0));   /* Memory Access Control  (0x20|0x80|0x08) thebrutzler hat ^0xC0 hinzugefuegt (180 grad rotation)*/                       \
